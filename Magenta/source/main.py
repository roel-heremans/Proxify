...
def plotly_data(df, col_name_dict, dict_for_plot_title):
    ...
    grap_title = 'File{}: {}<br>Temp over Time: Batch={}'.format(dict_for_plot_title['file'][0], dict_for_plot_title['file'][1], dict_for_plot_title['batch'])
...
if __name__ == "__main__":
    ...
    file_id = '01'
    selected_file = data_files.get(file_id)
